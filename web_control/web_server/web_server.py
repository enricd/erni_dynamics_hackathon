...
class Websocket(): 
    recv_dict = {
        'JA':[0,0], # Car control 
        'JB':[0,0], # Gimbal control 
        'SS':['off',0,0.5], # Horn sound effect 
        'SM':['off',0,0.5], # Horn play music 
        # 'SL':['off',0,0.5], # Horn play recording 
        'TT':['off','you'], # TTS 
        'US':'off', # Ultrasonic 
        'GS':"off", # Grayscale switch 
        'OA':'off', # Obstacle avoidance switch 
        'TL':['off',950], # Line following switch 
        'CD':['off',110], # Cliff detection switch 
        'HT':'off', # Face tracking switch 
        'HF':'off', # Face following switch 
        'CT':'off', # Color detection switch 
        'CF':'off', # Color following switch 
        'MS':['off',0,0], # Wheel test 
        'DO':['off',0], # Steering servo calibration 
        'PO':['off',0], # Gimbal left-right servo 
        'TO':['off',0] , # Gimbal up-down servo 
        'CC':'blue', # Color selection 
    }
    ...
    send_dict = {
        ...
        'GS':[0,0,0],
        'US':20,
        'DO':0,  # Steering servo calibration value
        'PO':0,
        'TO':0,
        'CC':'blue',
